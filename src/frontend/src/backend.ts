...
export class Backend implements backendInterface {
    ...
    async getPriceEstimate(arg0: bigint): Promise<PriceEstimate> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceEstimate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async recognizeProducts(): Promise<ProductRecognitionResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.recognizeProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
